...
fig4_User.png      -> After Build/Rebuild - Run #1: fromelf.exe --bin Objects\MyBlinky3.axf --output Objects\MyBlinky3.bin
...
nível que o diretório "MyBlinky3" e deve estar previamente compilado.
