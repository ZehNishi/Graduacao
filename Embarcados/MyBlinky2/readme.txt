...
Algumas utilizações do SDK TivaWare neste exemplo: Systick e GPIO.
...
fig4_User.png      -> After Build/Rebuild - Run #1: fromelf.exe --bin Objects\MyBlinky2.axf --output Objects\MyBlinky2.bin
...
nível que o diretório "MyBlinky2" e deve estar previamente compilado.
