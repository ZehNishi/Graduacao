...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 2251206492;
  checksumData[1] = 888028987;
  checksumData[2] = 2938239647;
  checksumData[3] = 3557308023;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 371615758;
    checksumData[1] = 2695166892;
    checksumData[2] = 4045147629;
    checksumData[3] = 976430561;
...

  {
    ...
    checksumData[0] = 2233799364;
    checksumData[1] = 938412941;
    checksumData[2] = 262495541;
    checksumData[3] = 3686687195;
...

  {
    ...
    checksumData[0] = 4092028652;
    checksumData[1] = 678847069;
    checksumData[2] = 4234690447;
    checksumData[3] = 945577477;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "eUHePDy2hsu2cPeKv5k5SC") == 0) {
    extern mxArray *cgxe_eUHePDy2hsu2cPeKv5k5SC_BuildInfoUpdate(void);
    plhs[0] = cgxe_eUHePDy2hsu2cPeKv5k5SC_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "eUHePDy2hsu2cPeKv5k5SC") == 0) {
    extern mxArray *cgxe_eUHePDy2hsu2cPeKv5k5SC_fallback_info(void);
    plhs[0] = cgxe_eUHePDy2hsu2cPeKv5k5SC_fallback_info();
    return 1;
  }
