#ifndef __eUHePDy2hsu2cPeKv5k5SC_h__
#define __eUHePDy2hsu2cPeKv5k5SC_h__
...
#ifndef struct_coder_array_real_T
#define struct_coder_array_real_T

struct coder_array_real_T
{
  struct {
    real_T *data;
    int32_T numel;
...
#endif                                 /* struct_coder_array_real_T */

#ifndef typedef_coder_array_real_T
#define typedef_coder_array_real_T

typedef struct coder_array_real_T coder_array_real_T;

#endif                                 /* typedef_coder_array_real_T */
...
#ifndef struct_tag_tw11suyEaFwu2LBMIAhmwD
#define struct_tag_tw11suyEaFwu2LBMIAhmwD

struct tag_tw11suyEaFwu2LBMIAhmwD
{
  char_T Value[3];
};

#endif                                 /* struct_tag_tw11suyEaFwu2LBMIAhmwD */

#ifndef typedef_s_tw11suyEaFwu2LBMIAhmwD
#define typedef_s_tw11suyEaFwu2LBMIAhmwD

typedef struct tag_tw11suyEaFwu2LBMIAhmwD s_tw11suyEaFwu2LBMIAhmwD;

#endif                                 /* typedef_s_tw11suyEaFwu2LBMIAhmwD */

#ifndef struct_tag_OpOftlV4gcRydHjKOAxc8
#define struct_tag_OpOftlV4gcRydHjKOAxc8

struct tag_OpOftlV4gcRydHjKOAxc8
{
  char_T Value[9];
};

#endif                                 /* struct_tag_OpOftlV4gcRydHjKOAxc8 */

#ifndef typedef_s_OpOftlV4gcRydHjKOAxc8
#define typedef_s_OpOftlV4gcRydHjKOAxc8

typedef struct tag_OpOftlV4gcRydHjKOAxc8 s_OpOftlV4gcRydHjKOAxc8;

#endif                                 /* typedef_s_OpOftlV4gcRydHjKOAxc8 */

#ifndef struct_tag_Rrdg8GN6iWZ6mxWzncjAVD
#define struct_tag_Rrdg8GN6iWZ6mxWzncjAVD

struct tag_Rrdg8GN6iWZ6mxWzncjAVD
{
  char_T Value[10];
};

#endif                                 /* struct_tag_Rrdg8GN6iWZ6mxWzncjAVD */

#ifndef typedef_s_Rrdg8GN6iWZ6mxWzncjAVD
#define typedef_s_Rrdg8GN6iWZ6mxWzncjAVD

typedef struct tag_Rrdg8GN6iWZ6mxWzncjAVD s_Rrdg8GN6iWZ6mxWzncjAVD;

#endif                                 /* typedef_s_Rrdg8GN6iWZ6mxWzncjAVD */
...
#ifndef struct_tag_5LRGHadRiXWKMUFhrmqEz
#define struct_tag_5LRGHadRiXWKMUFhrmqEz

struct tag_5LRGHadRiXWKMUFhrmqEz
{
...
#endif                                 /* struct_tag_5LRGHadRiXWKMUFhrmqEz */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_5LRGHadRiXWKMUFhrmqEz comm_CarrierSynchronizer;
...
#ifndef typedef_InstanceStruct_eUHePDy2hsu2cPeKv5k5SC
#define typedef_InstanceStruct_eUHePDy2hsu2cPeKv5k5SC
...
typedef struct {
  ...
  creal_T (*u0_data)[968306];
  int32_T (*u0_sizes)[2];
  creal_T (*y0_data)[968306];
  int32_T (*y0_sizes)[2];
  int32_T (*v)[2];
} InstanceStruct_eUHePDy2hsu2cPeKv5k5SC;

#endif                                 /* typedef_InstanceStruct_eUHePDy2hsu2cPeKv5k5SC */
...
extern void method_dispatcher_eUHePDy2hsu2cPeKv5k5SC(SimStruct *S, int_T method,
  void* data);
