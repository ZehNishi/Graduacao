...
static emlrtRSInfo x_emlrtRSI = { 57,  /* lineNo */
...
static emlrtRSInfo bb_emlrtRSI = { 167,/* lineNo */
  "carrierSyncCore",                   /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\+internal\\+carrierSync\\carrierSyncCore.m"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
...
static const mxArray *emlrt_marshallOut(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
...
static void init_simulink_io_address(InstanceStruct_fDtvgy2AehP9SrfQF6xUkB
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  creal_T u_tmp3_data[220];
  creal_T y_tmp0_data[220];
  real_T *DampingFactor;
  real_T *NormalizedLoopBandwidth;
  real_T *SamplesPerSymbol;
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static uint8_T uv[8] = { 220U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
  ...
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2])
{
  ...
  if (moduleInstance->sysobj.isInitialized != 1) {
    ...
    moduleInstance->sysobj.isInitialized = 1;
    d_st.site = &e_emlrtRSI;
    varSizes[0].f1[0] = (uint32_T)u0_size[0];
    varSizes[0].f1[1] = 1U;
    for (ret = 0; ret < 6; ret++) {
  ...
  u0[0] = u0_size[0];
  b_st.site = &e_emlrtRSI;
  CarrierSynchronizer_stepImpl(&b_st, &moduleInstance->sysobj, b_u0_data, u0,
    c_y0_data, b_y0_size);
  b_st.site = &e_emlrtRSI;
  SystemCore_checkTunablePropChange(&b_st, &moduleInstance->sysobj);
  emlrtDimSizeGeqCheckR2012b(220, b_y0_size[0], &emlrtECI, (void *)sp);
  ...
  phaseEstimate_data[], int32_T phaseEstimate_size[1])
{
  emlrtStack b_st;
  emlrtStack st;
  creal_T phaseCorrection_data[220];
  creal_T b;
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0_data = (creal_T (*)[220])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->u0_sizes = (int32_T (*)[2])cgxertGetCurrentInputPortDimensions
    (moduleInstance->S, 0);
  moduleInstance->y0_data = (creal_T (*)[220])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S, int_T tid)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S, int_T tid)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
  InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *moduleInstance =
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB *)calloc(1, sizeof
    (InstanceStruct_fDtvgy2AehP9SrfQF6xUkB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlInitializeConditions(S, mdlInitialize_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlUpdate(S, mdlUpdate_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlDerivatives(S, mdlDerivatives_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlTerminate(S, mdlTerminate_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlEnable(S, mdlEnable_fDtvgy2AehP9SrfQF6xUkB);
  ssSetmdlDisable(S, mdlDisable_fDtvgy2AehP9SrfQF6xUkB);
...
static void mdlProcessParameters_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S)
{
}

void method_dispatcher_fDtvgy2AehP9SrfQF6xUkB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_fDtvgy2AehP9SrfQF6xUkB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_fDtvgy2AehP9SrfQF6xUkB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_fDtvgy2AehP9SrfQF6xUkB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_fDtvgy2AehP9SrfQF6xUkB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: fDtvgy2AehP9SrfQF6xUkB.\n"
...
mxArray *cgxe_fDtvgy2AehP9SrfQF6xUkB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_fDtvgy2AehP9SrfQF6xUkB_fallback_info(void)
{
