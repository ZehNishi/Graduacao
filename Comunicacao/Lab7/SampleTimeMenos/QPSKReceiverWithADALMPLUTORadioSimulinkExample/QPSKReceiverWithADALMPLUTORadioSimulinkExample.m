...
% the <docid:plutoradio_ug#example-plutoradioQPSKTransmitterSimulinkExample QPSK Transmitter with ADALM-PLUTO Radio in Simulink>
% example. The receiver demodulates the received symbols and outputs a 
% simple message to the MATLAB(R) command line.
